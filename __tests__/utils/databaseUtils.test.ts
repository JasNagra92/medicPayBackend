...
//       id: "Sh30I2a1Glu5CMliv1pN1eX7qqyn",
//       email: "test",
//       shiftPattern: "Alpha",
//       platoon: "D",
//       rotation: "R1",
...
//     let updatedGross = 3754.49;
//     let newEIDeduction = 59.96;
//     let unionDues = 92.99;
//     let pserp = 312.81;
//     let incomeTax = 628.9;
//     let cppDeduction = 230.3;
//     let secondCPPDeduction =
...
describe("addDeductionsToDB", () => {
  it("should create a deductions array for a given user and populate it with deductions using the calculations with default values", async () => {
    let userInfoFromRequest: IUserDataForDB = {
      id: "test",
      email: "test",
      shiftPattern: "Alpha",
